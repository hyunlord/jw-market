...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--brands", nargs="*", help="Brands to process. Defaults to cache_deep_analysis_ai_analysis brand list.")
    ...
    parser.add_argument("--catalog", default="crawl/config/_catalog.json")
