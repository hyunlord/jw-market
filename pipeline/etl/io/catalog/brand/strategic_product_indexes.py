...
from pipeline.etl.io.catalog._lib.raw_sources import read_parquet_compat_rows
from pipeline.etl.io.catalog.brand.strategic_product_schema import IQVIA_JOIN_KEY_BY_SMID, UBIST_JOIN_KEY_BY_SMID
from pipeline.etl.io.catalog.brand.strategic_product_text import clean_text, manufacturer_key, normalize_key
