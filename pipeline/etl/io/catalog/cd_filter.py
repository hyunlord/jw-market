...
from pipeline.etl.io.catalog.cd_filter_specs import raw_filter_records
from pipeline.etl.io.catalog.cd_filter_validation import count_non_null, validate_records
from pipeline.etl.io.catalog.market_catalog_parquet import validate_written_schema, write_typed_parquet
from pipeline.etl.io.catalog.market_catalog_text import read_parquet_rows, source_file_version as source_file_version_from_rows
...
def load_cd_filter_records(
    ...
    from pipeline.etl.io.catalog.market_catalog_text import utc_now_datetime
