...
### 2026-07-28 portal manifest row-count baseline change

The UBIST G3 contract added one passing case proving that a portal manifest
without optional declared row counts is measured through the loader iterator.
The measured baseline changed from `2256 collected / 2246 passed / 5 failed /
5 skipped` to `2257 collected / 2247 passed / 5 failed / 5 skipped`.
