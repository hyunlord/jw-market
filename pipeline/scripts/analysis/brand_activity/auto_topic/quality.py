        ...
        market_rows.append(
            {
                ...
                "csd_market_missing": meta.get("csd_market_missing") is True,
                "csd_market_missing_atc4": meta.get("csd_market_missing_atc4") if isinstance(meta.get("csd_market_missing_atc4"), list) else [],
                "display_name_source": meta.get("display_name_source") or "atc4",
