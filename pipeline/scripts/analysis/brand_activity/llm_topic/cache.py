...
def stable_input_hash(rows: Sequence[KeywordRow], *, prompt_version: str, axis_version: str) -> str:
...
def build_cache_key(*, task: str, model_serving_id: str, prompt_version: str, input_hash: str) -> str:
    return f"{task}__serving-{model_serving_id}__{prompt_version}__{input_hash}"
