    ...
    *,
    ...
    for brand in metrics.all_brands:
        ...
        if retain_decoded_dimensions:
            dimension_data, decoded_dimension_data, decoded_by_dimension = with_dimension_series_from_labels_decoded(
                row.get("dimension_data"),
                row.get("by_dimension"),
                brand.history_by_period,
            )
            row["dimension_data"] = dimension_data
            row["__dimension_data"] = decoded_dimension_data
            row["__by_dimension"] = decoded_by_dimension
        else:
