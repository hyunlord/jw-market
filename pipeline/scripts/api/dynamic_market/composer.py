...
class ResponseComposer:
    ...
    def compose(self, *, definition: MarketDefinition, metrics: AggregatedMetrics) -> dict[str, Any]:
        """Return a JSON-ready cause-compatible dynamic-market response."""

        return deep_format_numbers(build_cause_payload(definition=definition, metrics=metrics))
