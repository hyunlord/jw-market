...
class BrandActivityTopicsRequest(BrandActivityBaseRequest):
    ...
    start_date: str | None = Field(default=None, description="표시 기간 시작월 YYYY-MM. 차원 필터 활성 시 행 집계에도 적용됩니다.")
    end_date: str | None = Field(default=None, description="표시 기간 종료월 YYYY-MM. 차원 필터 활성 시 행 집계에도 적용됩니다.")
    period_start: str | None = Field(default=None, description="Legacy 표시 기간 시작월 YYYY-MM.")
    period_end: str | None = Field(default=None, description="Legacy 표시 기간 종료월 YYYY-MM.")
