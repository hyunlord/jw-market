...
DEFAULT_INPUT_FILE = Path(
    "data/JW 주요 약품 수동 매핑/MI팀_시장분석 AI_시장 분석 Master Version (260422).xlsx"
)
...
def write_parquet(records: list[dict[str, Any]], output_file: Path) -> None:
    ...
    schema = pa.schema([pa.field(column, pa.string()) for column in MASTER_MARKET_DEFINITION_COLUMNS])
