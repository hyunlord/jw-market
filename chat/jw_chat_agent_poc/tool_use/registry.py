...
class ExternalToolRegistry:
    ...
    def list_for_query(self, user_text: str) -> tuple[ToolSpec, ...]:
        ...
        nedrug_timeout_s = mcp_read_timeout_s(
            NEDRUG_MCP_SOURCE,
            fallback=self._external.timeout_s,
        ) + 1.0
        hira_timeout_s = mcp_read_timeout_s(
            HIRA_MCP_SOURCE,
            fallback=self._external.timeout_s,
        ) + 1.0
        ...
        definitions = (
            ...
            ("get_drug_main_ingredient", BrandInput, self._mfds_main_ingredient, nedrug_timeout_s, ("external", "mfds")),
            ...
            ("mfds_permission_search", BrandInput, self._permission_search, nedrug_timeout_s, ("external", "mfds")),
            ("mfds_permission_detail", ItemSequenceInput, self._permission_detail, nedrug_timeout_s, ("external", "mfds")),
            ("mfds_composition", BrandInput, self._mfds_composition, nedrug_timeout_s, ("external", "mfds")),
            ("mfds_easy_drug", BrandInput, self._mfds_easy_drug, nedrug_timeout_s, ("external", "mfds")),
            ("mfds_clinical_trial_kr", ClinicalQueryInput, self._clinical_kr, nedrug_timeout_s, ("external", "mfds")),
            ...
            ("mfds_patent", IngredientInput, partial(self._ingredient_call, "mfds_patent", "국내 특허"), nedrug_timeout_s, ("external", "mfds")),
            ("mfds_fda_orangebook", IngredientInput, partial(self._ingredient_call, "mfds_fda_orangebook", "미국 특허/독점권"), nedrug_timeout_s, ("external", "orangebook")),
            ("hira_disease_name_code", DiseaseCodeInput, partial(self._disease_call, "hira_disease_name_code", "질병명/상병코드"), hira_timeout_s, ("external", "hira", "grounding")),
            ("hira_disease_hospitalization_outpatient_stats", DiseaseCodeInput, partial(self._disease_call, "hira_disease_hospitalization_outpatient_stats", "질병 입원/외래 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_disease_gender_age_stats", DiseaseCodeInput, partial(self._disease_call, "hira_disease_gender_age_stats", "질병 성별/연령 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_disease_institution_class_stats", DiseaseCodeInput, partial(self._disease_call, "hira_disease_institution_class_stats", "질병 기관종별 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_disease_area_stats", DiseaseCodeInput, partial(self._disease_call, "hira_disease_area_stats", "질병 지역 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_reimbursement_criteria", BrandInput, self._hira_reimbursement, 8.0, ("external", "hira")),
            ("hira_procedure_gender_ipat_opat_stats", ProcedureCodeInput, partial(self._procedure_call, "hira_procedure_gender_ipat_opat_stats", "진료행위 입원/외래 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_procedure_gender_age_stats", ProcedureCodeInput, partial(self._procedure_call, "hira_procedure_gender_age_stats", "진료행위 성별/연령 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_procedure_institution_class_stats", ProcedureCodeInput, partial(self._procedure_call, "hira_procedure_institution_class_stats", "진료행위 기관종별 통계"), hira_timeout_s, ("external", "hira")),
            ("hira_procedure_area_stats", ProcedureCodeInput, partial(self._procedure_call, "hira_procedure_area_stats", "진료행위 지역 통계"), hira_timeout_s, ("external", "hira")),
        )
