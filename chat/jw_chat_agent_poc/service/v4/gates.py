...
def apply_v4_gates(
    ...
    omit_hira_enumeration = len(hira_after_claims["expected"]) > 5 and any(
    ...
    hira_repair_eligible = not omit_hira_enumeration
    hira_repaired = bool(hira_after_claims["missing"] and hira_repair_eligible)
    if hira_repaired:
    ...
    trace["requested_hira_surface"] = {
        ...
        "enumeration_omitted": bool(
            hira_after_claims["missing"] and not hira_repair_eligible
        ),
