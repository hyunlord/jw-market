...
def _general_base(
    ...
    return {
        ...
        "market_cagr_5y_pct": market.market_cagr_5y_pct,
        "market_cagr_3y_pct": market.market_cagr_3y_pct,
        "brand_cagr_5y_pct": market.brand_cagr_5y_pct,
        "brand_cagr_3y_pct": market.brand_cagr_3y_pct,
        "analysis_levels": market.analysis_levels,
        "analysis_level_market_status": market.analysis_level_market_status,
        "level_top5_trend": market.level_top5_trend,
        "brand_trajectory": market.brand_trajectory,
        "growth_contribution": market.growth_contribution,
