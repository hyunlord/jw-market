...
TOOL_DESCRIPTION_CATALOG: tuple[ToolDescriptionRecord, ...] = (
    ...
    ToolDescriptionRecord("web_search", True, "최신 동향/가이드라인/학회/KOL 웹 검색. when to use: DB에 없는 시의성 정보이며 최신/뉴스처럼 발행일이 필요한 요청은 topic=news, 지속형 문서는 topic=general. when NOT to use: 시장 수치/매출/점유율."),
