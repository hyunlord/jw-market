...
INTERNAL_TOOL_DESCRIPTION_CATALOG: tuple[ToolDescriptionRecord, ...] = (
    _record(
        ...
        constraints=("brand·metric·period와 호환 가능한 scope·source가 필요하며 일반뷰 기본 시장은 단일 ATC4임",),
    ...
    _record(
        ...
        constraints=("anchor brand 또는 scope로 시장 범위를 해소하며 일반뷰 기본 시장은 단일 ATC4임",),
    ...
    _record(
        ...
        constraints=("anchor brand 또는 scope로 시장을 해소하며 일반뷰 기본 시장은 단일 ATC4임",),
    ...
    _record(
        ...
        constraints=("채널 축을 제공하는 source·scope 조합이어야 하며 일반 복합축 실행은 별도 계약이 필요함",),
    ...
    _record(
        ...
        constraints=("같은 strategic scope·source의 비교 가능한 전년 기간 값이 필요함",),
