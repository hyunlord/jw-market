...
_ANALYSIS_SLOTS: Mapping[BqContractId, tuple[AnalysisSlot, ...]] = MappingProxyType({
    ...
    "A3": (
        ...
        _slot("sales_per_patient", R, ("sales_per_patient_krw",), ("get_disease_stats", "get_brand_sales")),
    ...
    "B1": (
        _slot("comparison_periods", R, ("period",), ("get_brand_series",)),
        _slot("top_brand_share_delta_pctp", R, ("gain_loss",), ("get_top_brands",)),
        _slot("rank_change", R, ("rank_change",), ("get_top_brands",)),
        _slot("own_share_rank_change", R, ("share_delta_pctp", "own_rank_change"), ("get_brand_series", "get_top_brands"), require_all=True),
        _slot("share_of_growth", R, ("share_of_growth_pct",), ("get_brand_series",)),
        _slot("growth_decomposition", R, ("market_growth_pct", "excess_growth_pctp"), ("get_brand_series",), require_all=True),
        _slot("concentration_change", BR, ("hhi_change", "top3_concentration_change"), ("get_top_brands",)),
        _slot("competition_verdict", BR, ("insights",), ("get_brand_series", "get_top_brands")),
