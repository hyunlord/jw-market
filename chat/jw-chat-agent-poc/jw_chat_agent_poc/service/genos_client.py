        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "최근·최신·개정·이슈 질문의 웹 근거는 published_at이 있는 항목만 사용하고 게시일을 답변에 함께 적는다. "
                    "published_at이 없으면 게시일 미상으로 표시하되 최근·최신 근거에는 사용하지 않는다. "
                    "'최근 개정' 질문에서는 공식 시행일보다 오래된 웹 항목을 사용하지 않는다. "
