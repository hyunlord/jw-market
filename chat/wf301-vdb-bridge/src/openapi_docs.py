...
FIELD_DOCS: dict[str, tuple[str, Any]] = {
    ...
    "limits": ("Configured upload quota limits.", {"max_files": 10, "max_per_request": 10, "max_file_mb": 50, "max_session_mb": 50}),
...
RESPONSE_EXAMPLES: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("/upload", "post"): {"mode": "upload", "target_vdb_id": 139, "workflow_id": 301, "app_session_id": "puc-004928", "session_id": "puc-004928", "temp_vdb_index_id": 709, "temp_vdb_index": "Ab12_cd34_ef56", "temp_documents": [{"temp_document_id": 709, "file_name": "TEMP_DOCUMENT_709.xlsx", "file_path": "/nfs-root/temp-document/709/TEMP_DOCUMENT_709.xlsx"}], "quota": {"limits": {"max_files": 10, "max_per_request": 10, "max_file_mb": 50, "max_session_mb": 50}, "current_files": 0, "current_bytes": 0, "incoming_files": 1, "incoming_bytes": 26000, "allowed": True, "violations": [], "notes": []}, "errors": []},
    ...
    ("/quota/check", "get"): {"target_vdb_id": 139, "workflow_id": 301, "app_session_id": "puc-004928", "session_id": "puc-004928", "quota": {"limits": {"max_files": 10, "max_per_request": 10, "max_file_mb": 50, "max_session_mb": 50}, "current_files": 1, "current_bytes": 26000, "incoming_files": 0, "incoming_bytes": 0, "allowed": True, "violations": [], "notes": []}, "errors": []},
