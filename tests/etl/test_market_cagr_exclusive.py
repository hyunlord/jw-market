...
def test_brand_monthly_does_not_substitute_59_month_span_for_five_year_window() -> None:
    months = {
...
def test_brand_monthly_uses_exact_60_month_baseline_for_five_year_window() -> None:
    months = {
        f"{2021 + (5 + offset) // 12:04d}-{(5 + offset) % 12 + 1:02d}": 100.0 + offset
